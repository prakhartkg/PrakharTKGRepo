...
public class TestDate{
	...
	public static void main(String...args){
		...
		System.out.println("*****************************************************");
		d5=d2.addDays(60);
		System.out.println("Date 2 + 60 days: "+d5);
		MyDate d7=d2.addDays(200);
		System.out.println("Date 2 + 200 days: "+d7);
		MyDate d6=d2.addDays(365);
		System.out.println("Date 2 + 365 days: "+d6);
		System.out.println("Date 2: " +d2);
		d4=d1.addDays(10);
